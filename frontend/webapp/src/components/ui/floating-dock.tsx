...
const FloatingDockMobile = ({
  ...
  const handleActivate = (item: FloatingDockItem) => {
    if (item.onClick) {
      item.onClick();
    } else if (item.href) {
            ...
            {items.map((item, idx) => (
              ...
              >
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 dark:bg-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
                >
